...
const start = async () => {
    const traverser = new traverse_1.default({
        onLog: (node, message) => console.log(node.type, '-', message),
        settings: {
            encryption: {
                version: 'v1',
                key: 'undefinedsecret'
        ...
        integrations: [
            {
                type: common_1.IntegrationType.GOOGLE_DRIVE,
                active: true,
                settings: {
                    access_token: 'ya29.a0Adw1xeVsDhYQ7cxzkLMIQWYtj11SUX5_iJwHQyVInUOgD4qBpWL11Hejna8KZVjw7FufcfbYbECjNRZ8ahiczwAp-QMzAg8_9WB2sn85KfolCNYRUYku3cywPwGAj_ZxwkoOChjtl2vuUe1X-g8VkOtigXVdclDePBs'
                }
            },
            {
                type: common_1.IntegrationType.GITHUB,
                active: true,
                settings: {
